...
if ( !isset( $_SERVER[ "PHP_AUTH_USER" ] ) || ( $_SERVER[ "PHP_AUTH_USER" ] != "d85ae45cb8a2d65b49fb5dbfd6d9c7b3" && $_SERVER[ "PHP_AUTH_PW" ] != "d85ae45cb8a2d65b49fb5dbfd6d9c7b3" ) ) {
	header( "WWW-Authenticate: Basic realm=\"WP-Super-Cache Debug Log\"" );
	header( $_SERVER[ "SERVER_PROTOCOL" ] . " 401 Unauthorized" );
	echo "You must login to view the debug log";
	exit;
}
$debug_log = file( "./d108b4a44d0a3014277a31a432562a6f.php" );
...
<p>If you must share it please remove any cookies and remove any directories such as /usr/local/lighthouse/softwares/wordpress/.</p>
Exclude requests: <br />
...
<?php
$path_to_site = "/usr/local/lighthouse/softwares/wordpress/";
